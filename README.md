...
- 转盘抽取带有旋转动画、结果高亮和指针抖动反馈，不再是瞬时切换。
- 内置更丰富的传奇与现役高能力样本：乔丹、科比、詹姆斯、杜兰特、库里、奥尼尔、罗德曼、约基奇、SGA、字母哥、东契奇、塔图姆、文班亚马、安东尼·戴维斯等。
- 球员池支持中文名、英文名、常用缩写和风格标签检索，例如 `jordan / jokic / SGA / KD`。
...
- 自定义中文风格标签参考了 2K26 `MyPLAYER Builder` 的 archetype / scouting report 方向，并结合球员比赛风格做了贴近式建模，不是官方逐人标签表复刻。
